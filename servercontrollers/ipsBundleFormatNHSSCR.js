...
const { generateIPSBundleNHSSCR } = require('./servercontrollerfuncs/generateIPSBundleNHSSCR');
...
async function getIPSBundleNHSSCR(req, res) {
  ...
  try {
    ...
    const bundle = generateIPSBundleNHSSCR(ips, {
      includeNarrative,
...
module.exports = { getIPSBundleNHSSCR };