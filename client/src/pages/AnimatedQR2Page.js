        ...
        <div className="app">
            <div className="container">
                ...
                {selectedPatients.length > 0 && selectedPatient && <>
                    ...
                    <div className="button-container" style={{ marginTop: 10, gap: 8, display: 'flex' }}>
                        <Button
                    ...
                    <>
                        ...
                        >
                            <div style={{ flex: 1, maxWidth: qrSize }}>
                                <QRCode id="qr-canvas-left" value={leftPacket} size={qrSize} />
                            </div>

                            <div style={{ flex: 1, maxWidth: qrSize }}>
                                <QRCode id="qr-canvas-right" value={rightPacket} size={qrSize} />
                            </div>
                        </div>
