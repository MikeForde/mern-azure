...
function APIDocumentationPage() {
  ...
  const apiEndpoints = [
    ...
    { method: 'POST', endpoint: '/ipsfromhl7x', description: 'Create MongoDb IPS records from HL7 2.x format.', request: 'HL7 2.x - Plain Text', response: 'MongoDb - JSON as confirmation of record creation.' },
